...
class ETLProcess:
    def __init__(self):
        ...
        self.stg_table = 'STG_CUSTOMER'
        self.temp_table = 'TMP_CUSTOMER'
        self.target_table = 'D_CUSTOMER_LU'
        self.staging_schema = 'STG'
        self.temp_schema = 'TMP'
        self.target_schema = 'TGT'
        self.csv_file = r'csv\CUSTOMER.csv'
        self.cur = con.connection()

    def truncate_table(self, table_name):
        print('Inside customer_etl.py File.')
