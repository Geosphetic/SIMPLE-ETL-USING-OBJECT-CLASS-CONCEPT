...
class ETLProcess:
    def __init__(self):
        ...
        self.stg_table = 'STG_COUNTRY'
        self.temp_table = 'TMP_COUNTRY'
        self.target_table = 'D_COUNTRY_LU'
        self.staging_schema = 'STG'
        self.temp_schema = 'TMP'
        self.target_schema = 'TGT'
        self.csv_file = r'csv\COUNTRY.csv'
        self.cur = con.connection()

    def truncate_table(self, table_name):
        print('Inside country_etl.py File.')
    ...
    def upsert_data_to_target(self):
        ...
        upsert_query = f"""
            ...
            WHEN NOT MATCHED THEN 
                INSERT (id, COUNTRY_desc, START_DATE, END_DATE, INSERT_TS, UPDATE_TS, ACTIVE_RECORD) 
                VALUES (tmp.id, tmp.COUNTRY_desc, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), TRUE);
        """
