...
class ETLProcess:
    def __init__(self):
        ...
        self.stg_table = 'STG_SUBCATEGORY'
        self.temp_table = 'TMP_SUBCATEGORY'
        self.target_table = 'D_SUBCATEGORY_LU'
        self.staging_schema = 'STG'
        self.temp_schema = 'TMP'
        self.target_schema = 'TGT'
        self.csv_file = r'csv\SUBCATEGORY.csv'
        self.cur = con.connection()

    def truncate_table(self, table_name):
        print('Inside subcategory_etl.py File.')
    ...
    def upsert_data_to_target(self):
        ...
        upsert_query = f"""
            ...
            WHEN NOT MATCHED THEN 
                INSERT (id, subcategory_desc, category_id, START_DATE, END_DATE, INSERT_TS, UPDATE_TS, ACTIVE_RECORD) 
                VALUES (tmp.id, tmp.subcategory_desc, tmp.category_id, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), TRUE);
        """
